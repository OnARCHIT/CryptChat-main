...
URL_MODEL_ID = "from flask import Flask, request, jsonify
from flask_cors import CORS
import numpy as np
import joblib
import os
...
IMAGE_MODEL_ID = "from flask import Flask, request, jsonify
from flask_cors import CORS
import numpy as np
import joblib
import os
...
# === Google Drive model file IDs ===
URL_MODEL_ID = "1GnXL_BnJJq3B-MJ0olR7x5DNWx3veK2o"
IMAGE_MODEL_ID = "1TLFb0PasStQb5lOBgU8TD0WHzUBC_Cnf"
